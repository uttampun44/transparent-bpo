<div class="sidebar fixed bg-blue-950 top-0 h-[100vh]">
    <div class="siderbar-cols px-10 py-8 text-center">
        ...
        <div class="admin-image my-8 grid gap-y-1 justify-items-center">
            ...
            <span class="text-white font-normal text-lg leading-normal">User Profile</span>
        </div>

        <div class="siderbar-admin">
            <aside>
                <ul class="grid gap-y-5 mt-8">
                    <li><a href="{{route('user')}}" class="text-gray-400 leading-normal font-medium text-xl flex gap-x-4 items-center"><img src="{{asset('images/Dashboard.png')}}" alt="dashboard" />Dashboard</a></li>
                    <li><a href="{{route('profile.edit')}}" class="text-gray-400 leading-normal font-medium text-xl flex gap-x-4 items-center"><img src="{{asset('images/templates.png')}}" alt="templates" />Profile</a></li>
